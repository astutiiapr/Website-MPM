...
<header class="navbar" style="display: flex; justify-content: space-between; align-items: center; padding: 10px 5%;">
    ...
    <nav class="nav-links" style="display: flex; gap: 20px;">
      ...
      <a href="structure.php" style="color: white; text-decoration: none; font-weight: 600;">Anggota</a>
      <a href="profile.php" style="color: white; text-decoration: none; font-weight: 600;">Profile</a>
      <a href="index.php" style="color: #ff6600; text-decoration: none; font-weight: 600; margin-left: 10px;">← Back</a>
    </nav>
  </header>
<!-- NAVBAR -->
<div class="navbar">
...
<section>
  ...
  <div class="team">
    ...
    <!-- CARD 1 -->
    <div class="card">
      <img src="Folder Gambar/Ketua.jpg">
      <h3>Ratu Jelita</h3>
      <p>Ketua Umum</p>
      <div class="social">
    ...
    <!-- CARD 2 -->
    <div class="card">
      <img src="Folder Gambar/Sekum.jpg">
      <h3>Astuti</h3>
      <p>Sekretaris Umum</p>
      <div class="social">
    ...
    <!-- CARD 3 -->
    <div class="card">
      <img src="Folder Gambar/Kakom2.jpg">
    ...
    <!-- CARD 4 -->
    <div class="card">
      <img src="Folder Gambar/Kakom1.jpg">
     ...
     <!-- CARD 4 -->
    <div class="card">
      <img src="Folder Gambar/Kakom3.jpg">
    ...
    <div class="card">
      <img src="Folder Gambar/DistrikHMM.jpg">
      <h3> ALthaf Malik</h3>
    ...
    <div class="card">
      <img src="Folder Gambar/DistrikHMS.jpg">
    ...
    <div class="card">
      <img src="Folder Gambar/DistrikHME.jpg">
    ...
    <div class="card">
      <img src="Folder Gambar/DistrikHMAN.jpg">
    ...
    <div class="card">
      <img src="Folder Gambar/DistrikHMGP.jpg">
    ...
    <div class="card">
      <img src="Folder Gambar/DistrikHIMATIK.jpg">
      <h3> Hari Bernardo</h3>
    ...
    <div class="card">
      <img src="Folder Gambar/MPMBO.jpg">
