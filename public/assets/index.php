...
<body>
  ...
  <header class="navbar">
    ...
    <a href="structure.php">Anggota</a>
    <a href="pusat-data.php">Pusat Data MPM</a>
...
<section id="activity" class="activity">
  ...
  <div class="activity-wrapper">
    ...
    <div class="activity-card">
      <img src="sertijab-mpm.jpg" alt="sertijab-mpm"> 
    ...
    <div class="activity-card">
      <img src="ppok-mpm.jpeg" alt="ppok-mpm"> 
      <div class="activity-text">
    ...
    <div class="activity-card">
      <img src="cermin-mpm.jpeg" alt="cermin-mpm">
      <div class="activity-text">
...
<section id="structure" class="structure">
  ...
  <div class="structure-container">
    <img src="struktur-mpm.png" onclick="openImage(this.src)">
  </div>
</section>
